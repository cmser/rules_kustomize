...
PLATFORMS = {
    "darwin-arm64": struct(
        ...
        url = "https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/{}/kustomize_{}_darwin_arm64.tar.gz"
    ),
    "darwin-x64": struct(
        compatible_with = [
            "@platforms//os:macos",
        ...
        url = "https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/{}/kustomize_{}_darwin_amd64.tar.gz"
    ),
    "linux-arm64-gnu": struct(
        ...
        url = "https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/{}/kustomize_{}_linux_arm64.tar.gz"
    ),
    "linux-x64-gnu": struct(
        ...
        url = "https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/{}/kustomize_{}_linux_amd64.tar.gz"
    ),
    "win32-x64-msvc": struct(
        ...
        url = "https://github.com/kubernetes-sigs/kustomize/releases/download/kustomize/{}/kustomize_{}_windows_amd64.tar.gz"
    ),
}
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_github_cmser_rules_kustomize//:toolchain_type"]
    return [
        toolchain_info
    ]
...
toolchain(
    ...
    toolchain_type = "@com_github_cmser_rules_kustomize//:toolchain_type",
)
""".format(
            platform = platform,
